...
export function ContactPage() {
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          >
            ...
            <h3 className="text-xl tracking-wider">WhatsApp</h3>
            <p className="text-sm text-[var(--muted-foreground)] mt-2">De snelste manier om ons te bereiken</p>
          ...
          >
            ...
            <p className="text-sm text-[var(--muted-foreground)] mt-2">Voor vragen of reservaties</p>
            <p className="text-[var(--foreground)] mt-4 group-hover:text-[var(--primary)] transition-colors">
              {site.email}
            </p>
          </a>
          ...
          >
            ...
            <h3 className="text-xl tracking-wider">Telefoon</h3>
            <p className="text-sm text-[var(--muted-foreground)] mt-2">Bel ons direct</p>
            <p className="text-[var(--foreground)] mt-4 group-hover:text-[var(--primary)] transition-colors">
              {site.phone}
            </p>
          </a>
      ...
      <ParallaxSection id="contact-parallax" imageSrc="/parallax/para-4.png" height="sm" />
          ...
          <form className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 pb-3 border-b border-[var(--border)]">
                ...
                <h3 className="text-lg tracking-wider text-[var(--foreground)]">Persoonlijke Gegevens</h3>
              </div>
              <div className="grid gap-5 sm:grid-cols-2">
                <div className="relative">
                  <label className="block text-sm font-medium text-[var(--foreground)] mb-2">
                    Naam <span className="text-[var(--primary)]">*</span>
                  </label>
                ...
                <div className="relative">
                  <label className="block text-sm font-medium text-[var(--foreground)] mb-2">
                    Telefoon / WhatsApp <span className="text-[var(--primary)]">*</span>
                  </label>
                  <span className="pointer-events-none absolute left-3 top-[46px] text-[#1a1a1a]">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  className="w-full rounded-[var(--radius-sm)] pl-11 pr-4 py-3.5 text-sm border border-[var(--border)] bg-white text-[#1a1a1a] placeholder:text-[#4b4b4b] focus:border-[var(--primary)] focus:outline-none transition-colors"
                  placeholder="je@email.be (optioneel)"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 pb-3 border-b border-[var(--border)]">
                ...
                <h3 className="text-lg tracking-wider text-[var(--foreground)]">Reservatie Details</h3>
              </div>
              <div className="grid gap-5 sm:grid-cols-3">
                <div className="relative">
                  <label htmlFor="booking-date" className="block text-sm font-medium text-[var(--foreground)] mb-2">
                    Datum <span className="text-[var(--primary)]">*</span>
                  </label>
                  <span className="pointer-events-none absolute left-3 top-[46px] text-[#1a1a1a]">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                ...
                <div className="relative">
                  <label htmlFor="booking-time" className="block text-sm font-medium text-[var(--foreground)] mb-2">
                    Tijd <span className="text-[var(--primary)]">*</span>
                  </label>
                  <span className="pointer-events-none absolute left-3 top-[46px] text-[#1a1a1a]">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="relative">
                  <label htmlFor="booking-persons" className="block text-sm font-medium text-[var(--foreground)] mb-2">
                    Personen <span className="text-[var(--primary)]">*</span>
                  </label>
                  <span className="pointer-events-none absolute left-3 top-[46px] text-[#1a1a1a]">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="event">Privé Event</option>
                </select>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 pb-3 border-b border-[var(--border)]">
                ...
                <h3 className="text-lg tracking-wider text-[var(--foreground)]">Extra Opmerkingen</h3>
              </div>
              <div className="relative">
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Dieetwensen, allergieën, speciale gelegenheid, of andere vragen..."
                />
              </div>
            </div>
            ...
            <div className="pt-4">
              ...
              <p className="text-xs text-[var(--muted-foreground)] text-center mt-4 flex items-center justify-center gap-2">
                ...
                We bevestigen je reservatie zo snel mogelijk via WhatsApp of telefoon.
              </p>
            </div>
          </form>
        </div>
      ...
      <Section
        id="social"
        title="Volg Ons"
        subtitle="Stay connected — updates, events en behind-the-scenes op onze socials."
        variant="decorated"
      >
        <p className="text-sm text-[var(--muted-foreground)] max-w-3xl mx-auto text-center mb-8">
          Volg The Royal Falcon voor de laatste events, live sport aankondigingen en sfeerbeelden uit Arendonk.
          Zo mis je geen enkele special night of cocktail promo.
        </p>
        <div className="grid gap-4 sm:grid-cols-3 max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-[var(--foreground)] group-hover:text-[var(--primary)] transition-colors">Facebook</p>
          </a>
          <a
          ...
          >
            ...
            <p className="text-[var(--foreground)] group-hover:text-[var(--primary)] transition-colors">Instagram</p>
          </a>
          <a
          ...
          >
            ...
            <p className="text-[var(--foreground)] group-hover:text-[var(--primary)] transition-colors">TikTok</p>
          </a>
        </div>
      </Section>
    </div>
